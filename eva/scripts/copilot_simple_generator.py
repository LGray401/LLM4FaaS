...
def setup():
    ...
    }, data='{"client_id":"Iv23lia3fu1lDVEDyelI","scope":"read:user"}')
    ...
    while True:
        ...
        resp = requests.post('https://github.com/login/oauth/access_token', headers={
            ...
            'user-agent': 'GithubCopilot/1.155.0',
            'accept-encoding': 'gzip,deflate,br'
        }, data=f'{{"client_id":"Iv23lia3fu1lDVEDyelI","device_code":"{device_code}","grant_type":"urn:ietf:params:oauth:grant-type:device_code"}}')
        # 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
...
def main():
    # 预定义的prompts
    predefined_prompts = ["hi"]

    # 对每个预定义的prompt调用copilot函数
