...
# ```
#
# This script first retrieves the home plan and the living room. If the living room exists, it retrieves all the actuators in the living room. It then loops through each actuator and if the actuator is a light, it turns off the light.